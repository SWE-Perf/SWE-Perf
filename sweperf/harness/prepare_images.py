...
from sweperf.harness.constants import KEY_INSTANCE_ID
from sweperf.harness.docker_build import build_instance_images
from sweperf.harness.docker_utils import list_images
from sweperf.harness.test_spec import make_test_spec
...
def filter_dataset_to_build(
    ...
    Args:
        dataset (list): List of instances (usually all of SWE-perf dev/test split)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default="SWE-Perf", help="Name of the dataset to use")
